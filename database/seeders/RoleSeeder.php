...
class RoleSeeder extends Seeder
{
   ...
   public function run()
   {
      ...
      Permission::create(['name' => 'admin.categories.index'])->syncRoles([$role1, $role2]); // blogger can only list categories, not create, edit or destroy.
      ...
      Permission::create(['name' => 'admin.tags.index'])->syncRoles([$role1, $role2]); // blogger can only list tags, not create, edit or destroy.
